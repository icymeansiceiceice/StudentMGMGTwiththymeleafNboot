   ...
   <p th:text="${error}" style="color: red;"	></p>
      ...
      <form action="#" th:action="@{/StudentUpdate}" th:object="${stud}" method="post" >
            ...
            <div class="row mb-4">
                ...
                <input type="text" class="form-control"  th:field = *{name}  id="studentID" required="required">    
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <input type="date"   th:field = *{dob}  id="dob" class="form-control" required="required">
            ...
            <fieldset class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="form-check-inline">
                      <input type="radio"  th:attr="name='gender'" th:value="male"  checked class="form-check-input" id="gridRadios1">
                    ...
                    <div class="form-check-inline">
                       <input type="radio"  th:attr="name='gender'" th:value="female"   class="form-check-input" id="gridRadios1">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
               <input type="text"   th:field = *{phone} class="form-control"  id="phone" required="required">
               </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                   <select class="form-select" aria-label="Education" th:field = *{education} required="required">
